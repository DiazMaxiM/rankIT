...
public class Menu extends MainWindow<RankIT> {
  ...
  private Button contenedorBotonera(final Panel mainPanel) {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method or field open is undefined for the type AdmLugarWindow"
      + "\nLugar cannot be resolved."
      + "\nInvalid number of arguments. The constructor AdmLugarWindow() is not applicable for the arguments (Menu,Object)");
  }
