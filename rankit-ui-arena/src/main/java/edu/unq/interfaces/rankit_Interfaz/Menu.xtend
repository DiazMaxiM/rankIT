...
class Menu extends SimpleWindow<RankITAppModel> {
	...
	private def contenedorBotonera(Panel mainPanel) {
		...
		new Button(botoneraPanel) => [
			...
			onClick [ |
				new AdmUsuarioWindow(this,
					new UsuarioAppModel(this.modelObject.rankit.admCalificaciones,
						this.modelObject.rankit.admUsuarios)).open
				]
			]
			new Button(botoneraPanel) => [
			...
			new Button(botoneraPanel) => [
				...
				onClick [|
					new AdmServicioWindow(this, new PuntuableAppModel(this.modelObject.rankit.admPuntuables,
			...
			new Button(botoneraPanel) => [
				caption = "Adm. Lugares"
				onClick [|
					new AdmLugarWindow(this, new PuntuableAppModel(this.modelObject.rankit.admPuntuables,
						this.modelObject.rankit.admCalificaciones)).open
				]
			]
		}
